  ...
  return (
    ...
    className='Main' id="mainy">
      <div className="main_left">
        ...
        <h2 className='names'>Anurag gour</h2>
        ...
        <a href="https://github.com/gouranurag06" target="_blank" rel="noreferrer"><img src={github} alt=""  /></a>
        <a href="https://www.linkedin.com/in/vamsi-Anurag-92458a259?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noreferrer"><img src={linked_in} alt=""></img></a>
        <a href="https://leetcode.com/u/pG477o7BXM/" target="_blank" rel="noreferrer"><img src={leetcodes} alt=""></img></a>
        </div>
        </div>
        <div className="flex1">
        <a href="gouranurag06@gmail.com"><button className='buttonc'>E-Mail Me</button></a>
        <button onClick={() => window.open("https://drive.google.com/drive/folders/1_qCMKW-X_a23o762BR3D1VaSMjIdIsVW?usp=drive_link")} className='buttonb'>Resume</button>
        </div>
      </div>
